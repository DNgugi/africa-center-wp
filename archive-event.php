...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <form method="get" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="md:col-span-2 self-end">
                    ...
                    <?php if (!empty($_GET)) : ?>
                        <a href="<?php echo get_post_type_archive_link('event'); ?>" class="ml-2 text-gray-600 hover:text-gray-800">Reset Filters</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
        ...
        ?>
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-blue-800"><?php echo esc_html($formatted_date); ?></h2>
                    <?php endif; ?>

                    <div class="bg-white rounded-lg shadow-md p-0 mb-6 overflow-hidden hover:shadow-lg transition-shadow">
                        <div class="flex flex-col md:flex-row">
                            <div class="md:w-2/3 p-6 pr-4">
                                ...
                                <div class="text-gray-700 mb-4 text-base leading-relaxed">
                                ...
                                <div class="text-gray-600 text-sm">
                                    ...
                                    <?php if ($event_location) : ?>
                                        <div class="flex items-start">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-blue-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <?php if (has_post_thumbnail()) : ?>
                                <div class="md:w-1/3 flex-shrink-0 border-l border-gray-100">
                                    <div class="h-full flex items-center justify-center p-4">
                                        <?php the_post_thumbnail('thumbnail', array('class' => 'w-full h-auto object-contain max-h-[140px] rounded')); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
